...
public sealed class DiscordApiClient
{
	...
	internal DiscordApiClient(BaseDiscordClient client, RestClient? rest = null, HttpClient? http = null)
	{
		this._discord = client;
		rest ??= new RestClient(client.Configuration, client.Logger, http);
		this._rest = rest;
	}
	...
	(
		...
		=> this._rest = new(proxy, timeout, logger, http);
